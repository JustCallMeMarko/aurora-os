        ...
        <div className="flex w-full h-full mt-2">
          <div className="w-[58%] px-8 flex flex-col justify-center">
            ...
            <div className="grid grid-cols-4 gap-4 mt-2">
              <div className="bg-black/30 border-1 text-xs border-white/20 rounded-lg p-2 text-white hover:scale-110 transition-all duration-100 cursor-pointer h-[70px]">
                App Icon
              </div>
              <div className="bg-black/30 border-1 text-xs border-white/20 rounded-lg p-2 text-white hover:scale-110 transition-all duration-100 cursor-pointer h-[70px]">
                App Icon
          ...
          <div className="w-[42%] self-center">
            <div className="bg-black/30 border-1 border-white/20 rounded-lg px-4 py-2 flex flex-col w-[90%]">
              <h1 className="text-white font-semibold font-time  text-4xl">
                Today
              </h1>
              <p className="text-white text-xs font-time ml-2 mt-2">
                {new Date().toLocaleDateString()}
              </p>
              <LazyImage
                src={weather}
                alt="Weather icon"
                image="w-46 mx-auto h-32 mt-2"
                holder="w-46 mx-auto h-32 mt-2"
              />
              <p className="text-white text-3xl font-time mx-auto font-semibold">
                Sunny
              </p>
