  ...
  return (
    <div className=" absolute w-screen flex justify-end">
      <div className="flex flex-col p-8 group">
        <div className="grid grid-cols-2 gap-2 w-[310px]">
          <motion.div
            initial={{ scale: 1 }}
        ...
        <motion.div
          ...
          className="bg-black/50 border-1 group-hover:block hidden w-fit self-end border-white/30 rounded-full p-2 mt-1 mr-2 cursor-pointer"
        >
          <PencilIcon className="size-4 text-white  cursor-pointer" />
        </motion.div>
      </div>
    </div>
  );
